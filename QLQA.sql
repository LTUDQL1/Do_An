...
update DANH_MUC_MON_AN set TenDMMA = N'Món Măn' where MaDMMA = 'DMMA01'
update DANH_MUC_MON_AN set TenDMMA = N'Món Chay' where MaDMMA = 'DMMA02'
update DANH_MUC_MON_AN set TenDMMA = N'Tráng Miệng' where MaDMMA = 'DMMA03'
update DANH_MUC_MON_AN set TenDMMA = N'Nước' where MaDMMA = 'DMMA04'
update DANH_MUC_MON_AN set TenDMMA = N'Salad' where MaDMMA = 'DMMA05'